      ...
      <div class="mt-2">
        ...
        <div>
          <label class="inline-flex items-center">
            <input type="checkbox" name="permissionId.{{ $permissionsId }}" id="permissionId.{{ $permissionsId }}" value="{{ $permissionsId }}"
              {{ (in_array($permissionsId, $permissionId)) ? 'checked' : '' }}
              wire:click="setPermissionId({{ $permissionsId }})"
