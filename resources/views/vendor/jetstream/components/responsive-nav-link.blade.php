...
@php
  ...
  ? 'block pl-3 pr-4 py-2 border-l-4 border-jets-400 text-base font-medium text-jets-700 bg-jets-50 focus:outline-none focus:text-jets-800 focus:bg-jets-100 focus:border-indigo-700 transition'
